...
'157 staženo, z toho nových: 129': '157 staženo, z toho nových: 129',
...
'hlavní název publikace': 'hlavní název publikace',
...
'Spojení se souhrnným katalogem bylo navázáno, ale dotaz selhal': 'Spojení se souhrnným katalogem bylo navázáno, ale dotaz selhal',
...
'Zadej alespoň 3 znaky pro vyhledání.': 'Zadej alespoň 3 znaky pro vyhledání.',
'Zkus najít podle': 'Zkus najít podle',
'Čarový kód EAN': 'Čarový kód EAN',
'čarový kód, vytištěný na publikaci': 'čarový kód, vytištěný na publikaci',
}
